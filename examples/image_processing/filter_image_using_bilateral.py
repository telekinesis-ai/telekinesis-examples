...
def filter_image_using_bilateral_example():
    ...
    # ===================== Load Image ==========================================
    image_url = "https://telekinesis-public-assets.s3.us-east-1.amazonaws.com/examples/v1/images/nuts_scattered_noised.jpg"
    ...
    logger.success(
        "Applied filter_image_using_bilateral. Output image shape: {}", 
