...
def filter_image_using_laplacian_example():
    ...
    # ===================== Load Image ==========================================
    image_url = "https://telekinesis-public-assets.s3.us-east-1.amazonaws.com/examples/v1/images/flat_mechanical_component_denoised.png"
    ...
    logger.success(
        "Applied filter_image_using_laplacian. Output image shape: {}", 
