...
def filter_point_cloud_using_mesh_convex_hull_example():
    ...
    mesh_0 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_1 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_2 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_3 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_4 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_5 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_6 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_7 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
    mesh_8 = datatypes.Mesh3D.from_url(url=mesh_url, use_cache=True)
