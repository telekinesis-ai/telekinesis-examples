"""
Demonstrates stopping a conveyor belt in a running Isaac Sim stage.

Supports Isaac Sim only. The belt keeps the speed it is configured to run
at, so starting it again without a velocity resumes at that same speed.

Usage:
    python stop.py --prim_path <PRIM_PATH>
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Stop a conveyor belt in Isaac Sim")
