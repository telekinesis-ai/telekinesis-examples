...
Optionally drives the same trajectory on a robot simulated in Isaac Sim.
...
Run:
    python quickstart_set_joint_positions_universal_robots.py
    python quickstart_set_joint_positions_universal_robots.py --prim_path <PRIM_PATH>
"""
...
def main(prim_path: str | None) -> None:
    """Spin the UR10E's base while the elbow wiggles, and trace the TCP in rerun."""

    # =========================== Create Robot ==================================
    robot = universal_robots.UniversalRobotsUR10E(name="UniversalRobotsUR10E")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Drive a Universal Robots robot in joint space along a sweeping trajectory"
    )
