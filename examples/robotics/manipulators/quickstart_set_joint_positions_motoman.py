...
--prim_path is accepted for testing, but Isaac Sim is not yet implemented for Yaskawa Motoman
...
Run:
    python quickstart_set_joint_positions_motoman.py
    python quickstart_set_joint_positions_motoman.py --prim_path <PRIM_PATH>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Drive a Yaskawa Motoman robot in joint space along a sweeping trajectory"
    )
    parser.add_argument("--prim_path", type=str, default=None,
                         help='Isaac Sim articulation prim path, e.g. "/World/motoman_mh5"')
