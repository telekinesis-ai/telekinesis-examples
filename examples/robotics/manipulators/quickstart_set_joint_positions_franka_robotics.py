...
Run:
    python quickstart_set_joint_positions_franka_robotics.py
    python quickstart_set_joint_positions_franka_robotics.py --prim_path <PRIM_PATH>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Drive a Franka Robotics robot in joint space along a sweeping trajectory"
    )
