...
Run:
    ...
    python quickstart_set_cartesian_pose_universal_robots.py --prim_path <PRIM_PATH>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Drive a Universal Robots robot along a YZ-plane circle"
    )
    parser.add_argument("--prim_path", type=str, default=None,
                         help='Isaac Sim articulation prim path, e.g. "/World/ur16e"')
