...
--prim_path is accepted for testing, but Isaac Sim is not yet implemented for Fanuc
...
Run:
    python quickstart_set_joint_positions_fanuc.py
    python quickstart_set_joint_positions_fanuc.py --prim_path <PRIM_PATH>
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Drive a Fanuc robot in joint space along a sweeping trajectory"
    )
    parser.add_argument("--prim_path", type=str, default=None,
                         help='Isaac Sim articulation prim path, e.g. "/World/fanuc_m10ia"')
