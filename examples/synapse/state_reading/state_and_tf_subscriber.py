...
Usage:
    ...
    python state_and_tf_subscriber.py --ip 192.168.1.100    # real robot
"""
...
def main() -> None:
    ...
    try:
        ...
        # Log in commanded-cache state and TF transforms
        # while offline for 5 seconds
        time.sleep(5)

        # Connect to robot (switches the publisher to live telemetry)
