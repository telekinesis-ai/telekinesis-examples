...
Run:
    python examples/py/ur10e_schunk_rerun.py                  # defaults to EGU 50
    python examples/py/ur10e_schunk_rerun.py --gripper egp
    python examples/py/ur10e_schunk_rerun.py --gripper pznplus
    python examples/py/ur10e_schunk_rerun.py --gripper pzv64
"""
