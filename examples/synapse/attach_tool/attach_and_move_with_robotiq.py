...
Run:
    python examples/py/ur10e_robotiq_rerun.py              # defaults to 2F-85
    python examples/py/ur10e_robotiq_rerun.py --gripper 2f140
    python examples/py/ur10e_robotiq_rerun.py --gripper hande
"""
