...
Usage:
    python connect_and_disconnect_example.py --ip <ROBOT_IP>
"""
...
def connect_and_disconnect(ip: str):
...
def main():
    """
    Run the connect and disconnect example.
    Usage:
        python connect_and_disconnect_example.py --ip <ROBOT_IP>
    """
    ...
    # Run the example
    connect_and_disconnect(ip=args.ip)
