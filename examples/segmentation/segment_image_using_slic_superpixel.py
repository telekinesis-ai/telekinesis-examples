...
- Segments it into compact superpixels using the SLIC algorithm.
...
def segment_image_using_slic_superpixel_example():
    ...
    # ===================== Run Skill ==========================================
    annotations = cornea.segment_image_using_slic_superpixel(
...
def visualize(image: datatypes.Image, annotations_dict: dict) -> None:
    """Visualizes the original image and the superpixel segmentation mask using Rerun."""
