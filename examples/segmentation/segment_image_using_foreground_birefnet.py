...
def segment_image_using_foreground_birefnet_example():
    ...
    # ===================== Run Skill ==========================================
    annotations = cornea.segment_image_using_foreground_birefnet(
...
def visualize(image: datatypes.Image, annotations_dict: dict) -> None:
    """Visualizes the original image and the foreground segmentation mask using Rerun."""
...
if __name__ == "__main__":
    segment_image_using_foreground_birefnet_example()
