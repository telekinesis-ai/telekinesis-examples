...
- Segments it using flood fill from a seed point.
...
def segment_image_using_flood_fill_example():
    ...
    # ===================== Load Image ==========================================
    image_url = "https://telekinesis-public-assets.s3.us-east-1.amazonaws.com/examples/v1/images/erode.jpg"
    image = fetch_image(image_url)

    # ===================== Run Skill ==========================================
    annotations = cornea.segment_image_using_flood_fill(
...
if __name__ == "__main__":
    segment_image_using_flood_fill_example()
