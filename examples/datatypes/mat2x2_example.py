...
def mat2x2_example():
    ...
    datatypes.visualize(mat, entity_path="/Mat2x2")

    # ======================= Update ============================================
    updated_data = [[5.0, 6.0], [7.0, 8.0]]
    mat.data = updated_data

    logger.info(f"Updated Mat2x2: {mat}")
    datatypes.visualize(mat, entity_path="/Mat2x2/updated")

    # ======================= NumPy Interop =====================================
    summed = mat + np.array([[1.0, 1.0], [1.0, 1.0]])
