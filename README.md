<div align="center">
  <p>
    <a href="https://github.com/telekinesis-ai">
      <img width="100%" src="telekinesis_banner.png" />
    </a>
  </p>
...
- Object Detection 
```bash
python examples/detection/run_retina_examples.py                                # Object Detection
```
...
@software{telekinesis_ai,
  ...
  title  = {Telekinesis Agentic OS},
  year   = {2026},
  url    = {https://github.com/telekinesis-ai/telekinesis-examples},
  note   = {Apache-2.0}
}
```
